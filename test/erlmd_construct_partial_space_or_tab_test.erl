...
single_space_test() ->
    ...
    {{retry, space_or_tab_start}, T1} = erlmd_construct_partial_space_or_tab:space_or_tab(T),
...
min_max_exact_test() ->
    T = test_helper:make_tokenizer(<<"  abc">>),
    {{retry, space_or_tab_start}, T1} = erlmd_construct_partial_space_or_tab:space_or_tab_min_max(T, 2, 2),
    {ok, T2} = test_helper:run_construct(space_or_tab_start, T1),
...
min_max_too_few_test() ->
    T = test_helper:make_tokenizer(<<" abc">>),
    {{retry, space_or_tab_start}, T1} = erlmd_construct_partial_space_or_tab:space_or_tab_min_max(T, 2, 4),
    {nok, _T2} = test_helper:run_construct(space_or_tab_start, T1).

min_max_within_range_test() ->
    T = test_helper:make_tokenizer(<<"   abc">>),
    {{retry, space_or_tab_start}, T1} = erlmd_construct_partial_space_or_tab:space_or_tab_min_max(T, 1, 4),
    {ok, T2} = test_helper:run_construct(space_or_tab_start, T1),
...
min_zero_optional_test() ->
    ...
    T = test_helper:make_tokenizer(<<"abc">>),
    {{retry, space_or_tab_start}, T1} = erlmd_construct_partial_space_or_tab:space_or_tab_min_max(T, 0, 4),
    {ok, T2} = test_helper:run_construct(space_or_tab_start, T1),
